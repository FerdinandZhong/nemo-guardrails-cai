#!/usr/bin/env python3
"""
Setup CML project for NeMo Guardrails deployment.
...
class ProjectSetup:
    ...
    def __init__(self):
        ...
        self.project_name = "nemo-guardrails-cai"
    ...
    def create_project_with_git(
        ...
        project_data = {
            "name": project_name,
            "description": "NeMo Guardrails deployment project",
            "template": "git",
    ...
    def run(self) -> bool:
        ...
        print("=" * 70)
        print("🚀 CML Project Setup for NeMo Guardrails")
        print("=" * 70)
